(function (global, factory) {
  ...
  var Lenis = /*#__PURE__*/function () {
    ...
    function Lenis(_temp) {
      ...
      this.registerPlugin = function (plugin, options) {
      ...
      this.initializePlugins = function () {
        _this.plugins.forEach(function (_ref3) {
          var plugin = _ref3.plugin,
            options = _ref3.options;
          plugin(_this, options);
        });
      };
    ...
    _proto.scrollTo = function scrollTo(target, _temp2) {
      ...
      var _ref4 = _temp2 === void 0 ? {} : _temp2,
        ...
        immediate = _ref4$immediate === void 0 ? false : _ref4$immediate,
        _ref4$lock = _ref4.lock,
        lock = _ref4$lock === void 0 ? false : _ref4$lock,
        _ref4$duration = _ref4.duration,
        duration = _ref4$duration === void 0 ? this.options.duration : _ref4$duration,
        _ref4$easing = _ref4.easing,
        easing = _ref4$easing === void 0 ? this.options.easing : _ref4$easing,
        _ref4$lerp = _ref4.lerp,
        lerp = _ref4$lerp === void 0 ? !duration && this.options.lerp : _ref4$lerp,
        onComplete = _ref4.onComplete,
        _ref4$force = _ref4.force,
        force = _ref4$force === void 0 ? false : _ref4$force,
        _ref4$programmatic = _ref4.programmatic,
        programmatic = _ref4$programmatic === void 0 ? true : _ref4$programmatic;
      ...
      this.animate.fromTo(this.animatedScroll, target, {
        ...
        easing: easing,
        lerp: lerp,
        onUpdate: function onUpdate(value, _ref5) {
